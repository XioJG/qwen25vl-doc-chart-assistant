...
> 基于开源 Qwen2.5-VL-3B 搭建多模态文档与图表理解系统，完成本地推理、Gradio Demo、数据集构建、LLaVA 格式转换、4-bit QLoRA 微调、结构化抽取评测与模型前后对比分析。

更进一步的量化写法：

> 自建 XX 条图表 / 文档字段抽取数据，完成 Qwen2.5-VL-3B 的 4-bit QLoRA 微调；搭建本地 Gradio 演示系统，支持图片问答、字段抽取、JSON 输出；设计 QA 与结构化抽取双评测流程，对比微调前后指标变化。
